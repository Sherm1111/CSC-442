...
# Calculates the largest interval possible for byte-based storage
...
# Stores the input hidden file into the input wrapper file using the byte method.
...
SENTINEL = bytearray([0x0, 0xff, 0x0, 0x0, 0xff, 0x0])  # Hardcoded values
store_mode = False
bit_mode = False
offset = 0
interval = 1
